  ...
  return (
    <section className="bg-[#583490] text-white pt-16 pb-24 px-4 sm:px-8 md:px-20">
      <div className="max-w-7xl mx-auto">
        ...
        {/* OUTER: left is flexible (1fr) and right is auto-sized */}
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-24 md:gap-20 xl:gap-32 items-start">

          {/* LEFT SECTION — allow it to shrink/wrap */}
          ...
          {/* RIGHT SECTION — unchanged internal spacing, never shrinks, hidden under lg */}
          {/* Important: `shrink-0` + fixed width prevents compression/overlap */}
          <div className="hidden lg:grid grid-cols-2 pt-14 shrink-0 w-[500px]">
