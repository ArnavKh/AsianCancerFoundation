  ...
  return (
    <div className="bg-[#f8f5f0] min-h-screen pt-6 pb-6 px-4 sm:px-6 md:px-0">
      ...
      <div className="relative mb-6 mt-6 max-w-[1080px] mx-auto">
        ...
        <Link
          to="/workinaction"
          className="absolute  sm:left-0 top-1/2 -translate-y-1/2"
        >
      ...
      <div className="w-full max-w-[1080px] mx-auto pb-8 sm:pb-10 text-gray-800 px-1 sm:px-0">
        ...
        <p className="text-base sm:text-lg md:text-2xl mb-4 font-didact">
          VIBGYOR was a unique musical fundraiser for children with cancer, featuring seven music genres inspired by the chakras & musical notes, including classical, devotional, Sufi, ghazals, instrumental & contemporary styles.
        </p>
