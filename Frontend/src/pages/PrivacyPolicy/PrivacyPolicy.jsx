...
const AccordionItem = ({ title, preview, children }) => {
  ...
  return (
    <div className="border-b border-gray-200 py-4 bg-[#f8f5f0]">
      ...
      >
        <h2 className="text-3xl font-semibold text-purple-800 font-visby">
          {title}
        </h2>
        {isOpen ? (
...
const PrivacyPolicy = () => {
  return (
    <section className="p-6 bg-[#f8f5f0] rounded-lg px-20 pb-30">
      <h1 className="text-center text-5xl font-bold text-purple-700 mb-6 font-visby pt-10 pb-20">
        PRIVACY NOTICE
      </h1>
      ...
      <div>
        <h2 className="text-3xl font-semibold text-purple-800 font-visby pt-3">Contact for Queries – Asian Cancer Foundation (ACF)</h2>
