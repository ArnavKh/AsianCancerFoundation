...
const WhyGiveUs = () => {
  return (
    <section className="px-4 md:px-20 pt-20 pb-15 bg-purple-800 text-white">
        <h2 className="text-2xl md:text-4xl font-semibold mb-6 text-orange-400 font-visby">
          Why Give to Asian Cancer Foundation?
        </h2>
        <ul className="space-y-3 mb-8 text-base md:text-3xl font-didact">
          <li>
